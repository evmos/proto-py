...
from evmosproto.google.protobuf import descriptor_pb2 as google_dot_protobuf_dot_descriptor__pb2
...
interface_type = _descriptor.FieldDescriptor(
  name='interface_type', full_name='cosmos_proto.interface_type', index=0,
...
implements_interface = _descriptor.FieldDescriptor(
  name='implements_interface', full_name='cosmos_proto.implements_interface', index=1,
...
accepts_interface = _descriptor.FieldDescriptor(
  name='accepts_interface', full_name='cosmos_proto.accepts_interface', index=2,
  number=93001, type=9, cpp_type=9, label=1,
  has_default_value=False, default_value=b"".decode('utf-8'),
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
