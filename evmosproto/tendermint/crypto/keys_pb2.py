...
_PUBLICKEY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='ed25519', full_name='tendermint.crypto.PublicKey.ed25519', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='secp256k1', full_name='tendermint.crypto.PublicKey.secp256k1', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='sum', full_name='tendermint.crypto.PublicKey.sum',
