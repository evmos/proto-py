...
from evmosproto.cosmos.mint.v1beta1 import mint_pb2 as cosmos_dot_mint_dot_v1beta1_dot_mint__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,cosmos_dot_mint_dot_v1beta1_dot_mint__pb2.DESCRIPTOR,])
...
_QUERYPARAMSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='params', full_name='cosmos.mint.v1beta1.QueryParamsResponse.params', index=0,
...
_QUERYINFLATIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='inflation', full_name='cosmos.mint.v1beta1.QueryInflationResponse.inflation', index=0,
...
_QUERYANNUALPROVISIONSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='annual_provisions', full_name='cosmos.mint.v1beta1.QueryAnnualProvisionsResponse.annual_provisions', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUERYPARAMSRESPONSE.fields_by_name['params'].message_type = cosmos_dot_mint_dot_v1beta1_dot_mint__pb2._PARAMS
...
DESCRIPTOR.message_types_by_name['QueryAnnualProvisionsRequest'] = _QUERYANNUALPROVISIONSREQUEST
DESCRIPTOR.message_types_by_name['QueryAnnualProvisionsResponse'] = _QUERYANNUALPROVISIONSRESPONSE
